...
* [`src/cljs/forest/`](src/cljs/forest/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/forest/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `forest` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/forest/config.cljs) defaults to `true` in
...
```clj
(ns forest.example
  (:require [forest.config :as config])
